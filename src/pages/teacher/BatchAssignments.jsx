 ...
 return (
    <div className="flex">
      ...
      <div className="container mx-auto px-4 py-8 ml-56">
        <h2 className="text-3xl font-bold mb-4 text-white">Batch Assignments</h2>
              ...
              >
                <div>
                 ...
                 <div className="flex items-center mt-2">
                    <img src={assignment.student.avatar} alt="Student Avatar" className="w-10 h-10 rounded-full mr-2 object-cover" />
                    <div>
                      <div className="text-sm font-medium">{assignment.student.name}</div>
                    </div>
                 </div>
                </div>
